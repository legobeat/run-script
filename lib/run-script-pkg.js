import makeSpawnArgs from './make-spawn-args.js'
import promiseSpawn from '@npmcli/promise-spawn'
import packageEnvs from './package-envs.js'
import nodeGyp from '@npmcli/node-gyp'
const { isNodeGypPackage, defaultGypInstallScript } = nodeGyp
...
export default async options => {
  ...
  if (stdio === 'inherit') {
    ...
    banner += '\n'
    const procLog = (await import('proc-log')).default
    const { output, input } = procLog
